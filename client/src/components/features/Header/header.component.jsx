...
import { logoutProfile } from "../../../redux/actions/authActions";
...
function HeaderComponent({logoutProfile,history,auth}) {
    const classes = useStyles();

    const onLogoutClick = e => {
        e.preventDefault();
        logoutProfile(history);
...
export default withRouter(connect(mapStateToProps, { logoutProfile })(HeaderComponent))